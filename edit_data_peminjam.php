            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Data Peminjam</h1>
                        ...
                        <div class="row">
                    <div class="col-lg-6">
                        <form action="simpan_edit_peminjam.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="kode_peminjam" value="<?php echo $data_peminjam[0]['kode_peminjam']; ?>"/>
                            <div class="form-group">
                                <label>Username Peminjam</label>
                                <input type="text" name="kode_peminjam" class="form-control" value="<?php echo $data_peminjam[0]['kode_peminjam']; ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label>Nama Peminjam</label>
                                <input type="text" name="nama_peminjam" class="form-control" value="<?php echo $data_peminjam[0]['nama_peminjam']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Program Studi</label>
                                <input type="text" name="prodi" class="form-control" value="<?php echo $data_peminjam[0]['prodi']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Kelas</label>
                                <input type="text" name="kelas" class="form-control" value="<?php echo $data_peminjam[0]['kelas']; ?>">
                            </div>
                            <div class="form-group">
                                <label>NIM</label>
                                <input type="text" name="nim" class="form-control" value="<?php echo $data_peminjam[0]['nim']; ?>">
                            </div>
                            <div class="form-group">
                                <label>No Hp</label>
                                <input type="text" name="no_hp" class="form-control" value="<?php echo $data_peminjam[0]['no_hp']; ?>">
                            </div>
                            <div class=" form-group custom-file">
                                ...
                                <input type="file" name="foto_nim" class="custom-file-input">
                                <?php
                                } else {
                                ?>
                                <br>
                                <img src="<?php echo $data_peminjam[0]['foto']; ?>" alt="" width="150" height="100"><br>
                                <br>
                                <input type="file" name="foto_nim" class="custom-file-input">
                                <?php
                                }
