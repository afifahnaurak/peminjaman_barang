            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                    <div class="col-lg-6">
                        <form action="simpan_edit_peminjaman.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="kode_peminjaman" value="<?php echo $peminjaman[0]['kode_peminjaman']; ?>"/>
                            <div class="form-group">
                                <label>Kode Peminjaman</label>
                                <input type="text" name="kode_peminjaman" class="form-control" value="<?php echo $peminjaman[0]['kode_peminjaman']; ?>" disabled>
                            </div>
                            <div class="form-group">
                                <label>Mata Kuliah</label>
                                <input type="text" name="matkul" class="form-control" value="<?php echo $peminjaman[0]['matkul']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Dosen Pengampu</label>
                                <input type="text" name="dosen" class="form-control" value="<?php echo $peminjaman[0]['dosen']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Ruangan</label>
                                <input type="text" name="ruangan" class="form-control" value="<?php echo $peminjaman[0]['ruangan']; ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="kode_barang" class="form-control">
                                    <?php
                                    $no = 1;
                                    $kode_barang = $peminjaman[0]['kode_barang'];
                                    foreach($db->ambil_data_barang() as $x){
                                        echo "<option value=".$x['kode_barang'];
                                        if($x['kode_barang']==$kode_barang){echo " selected=selected";}
                                        echo ">" . $x['nama_barang']. "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="kode_peminjam" class="form-control">
                                    <?php
                                    $no = 1;
                                    $kode_peminjam = $peminjaman[0]['kode_peminjam'];
                                    foreach($db->ambil_data_peminjam() as $x){
                                        echo "<option value=".$x['kode_peminjam'];
                                        if($x['kode_peminjam']==$kode_peminjam){echo " selected=selected";}
                                        echo ">" . $x['nama_peminjam']. "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_pinjam" class="form-control" value="<?php echo $peminjaman[0]['tanggal_pinjam']; ?>">
                            </div>
                            <div class="form-group">
                                <label>Tanggal Pengembalian</label>
                                <input type="date" name="tanggal_kembali" class="form-control" value="<?php echo $peminjaman[0]['tanggal_kembali']; ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="kode_status" class="form-control">
                                    <?php
                                    $no = 1;
                                    $kode_status = $peminjaman[0]['kode_status'];
                                    foreach($db->tampil_data_status() as $x){
                                        echo "<option value=".$x['kode_status'];
                                        if($x['kode_status']==$kode_status){echo " selected=selected";}
                                        echo ">" . $x['keterangan_status']. "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
