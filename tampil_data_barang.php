                ...
                <div class="container-fluid px-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $x['merek_barang']; ?></td>
                            <td><?php echo $x['tipe_barang']; ?></td>
                            <td><?php echo $x['jumlah_barang']; ?></td>
                            <td><a href="edit_data_barang.php?id=<?php echo $x['kode_barang']; ?>">Edit</a></td>
                            <td><a href="hapus_data_barang.php?id=<?php echo $x['kode_barang']; ?>" onClick="return confirm('Anda yakin akan menghapus?'); if (ok) return true; else return false"><font color="red">Hapus</font></a></td>
                        </tr>
                        <?php
                            }
                        ?>
