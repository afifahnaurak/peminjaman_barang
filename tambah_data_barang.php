                    ...
                    <div class="col-lg-6">
                        <form action="simpan_data_barang.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="merek_barang" class="form-control" placeholder="Merek Barang">
                            </div>
                            <div class="form-group">
                                <label>Tipe Barang</label>
                                <input type="text" name="tipe_barang" class="form-control" placeholder="Tipe Barang">
                            </div>
                            <div class="form-group">
