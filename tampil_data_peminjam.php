...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">List Data Peminjam</h1>
    ...
    <tr>
        ...
        <td>
            ...
            ?>
                <img src="<?php echo $x['foto']; ?>" alt="" width="100" height="70">
            <?php
            }
            ?>
        </td>
        <td><a href="edit_data_peminjam.php?id=<?php echo $x['kode_peminjam']; ?>">Edit</a></td>
        <td><a href="hapus_data_peminjam.php?id=<?php echo $x['kode_peminjam']; ?>" onClick="return confirm('Anda yakin akan menghapus?'); if (ok) return true; else return false"><font color="red">Hapus</font></a></td>
    </tr>
    <?php
    }
    ?>
